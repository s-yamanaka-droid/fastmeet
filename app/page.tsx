    ...
    <main style={{ background: "#fff", color: "#1d1d1f" }}>
      ...
      <section style={{ padding: "80px 24px 60px", background: "linear-gradient(180deg, #f5f9ff 0%, #ffffff 100%)" }}>
        <div style={{ maxWidth: 880, margin: "0 auto", textAlign: "center" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 12px", background: "#fff8e1", color: "#9c6f00", borderRadius: 20, fontSize: 12, fontWeight: 600, marginBottom: 20 }}>
            <span style={{ width: 6, height: 6, borderRadius: 3, background: "#f5a623" }} />
            Google OAuth 本番審査中 ・ ゲスト予約はいつでも利用可
          </div>
      ...
      <section style={{ padding: "60px 24px", background: "#1d1d1f", color: "#fff" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 14, color: "#a0a0b0", marginBottom: 28, lineHeight: 1.7 }}>
            30分・45分・60分から選択。Googleカレンダー連携でリアルタイム空き表示。
          </p>
          <Link href="/book/yamanaka" style={{
            display: "inline-flex", alignItems: "center", gap: 10,
            padding: "13px 26px",
